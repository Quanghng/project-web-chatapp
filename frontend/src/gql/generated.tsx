...
export type UserLoggedInSubscription = { __typename?: 'Subscription', userLoggedIn: { __typename?: 'User', id: number, email: string, firstName?: string | null, lastName?: string | null } };
